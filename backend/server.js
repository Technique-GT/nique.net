...
const defaultAllowedOrigins = ['https://main.technique-4t5.pages.dev','https://www.nique.net','https://nique.net','https://technique-4t5.pages.dev/', 'http://localhost:5173', 'http://localhost:5174', 'http://localhost:5050'];
const envOrigins = [

...
function FeaturedStory({ article, priority = false }: FeaturedStoryProps) {
        ...
        <div className="flex flex-col flex-1 min-h-0">
            ...
            >
                ...
                <div className="relative z-10 pointer-events-none">
                    ...
                    <h3 className="title text-black font-bold text-3xl/7 mb-2">{article.title}</h3>
                    <h6 className="text-[#1A1E47] text-sm"><span className="uppercase">{category}</span> &#8226; {author}</h6>
                </div>
            </div>

            <h6 className="text-nique-blue text-xs mt-1">{article.imageCaption}</h6>
            <p

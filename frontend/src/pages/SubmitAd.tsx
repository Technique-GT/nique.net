                ...
                <div className="my-4">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 justify-between radius-md">
                        <div className="border rounded-md border-nique-blue py-12 px-20">
                            ...
                            <button className='bg-nique-blue hover:bg-nique-blue-hover rounded-md text-white px-2 py-1' onClick={onClick}><h4>Read the rules</h4></button>
                        </div>
                        ...
                        <div className="border rounded-md border-nique-blue py-12 px-20">
                            ...
                            <a href="https://epay.gatech.edu/C20793_ustores/web/store_main.jsp?STOREID=13&FROMQRCODE=true" target="_blank" rel="noopener noreferrer">
                                <button className='bg-nique-blue hover:bg-nique-blue-hover rounded-md text-white px-2 py-1'><h4>Submit your ad</h4></button>
                            </a>
                        </div>
                    </div>
                </div>
